...
It does **not** create the GitHub repo, Netlify site, or Supabase project — those are
the surrounding build steps (and a later iteration). v0 produces the app's files and
a precise setup checklist.
...
- Next: repo/site/Supabase provisioning; intent→action expansion for the Do registry;
  ajv-backed validation; YAML input.
