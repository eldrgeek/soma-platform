...
(function (global) {
  ...
  var OWNER_SECRET  = '__OWNER_SECRET__';   /* raw secret — for URL param check */
  var OWNER_TOKEN   = '__OWNER_TOKEN__';    /* SHA-256(secret) — stored in localStorage */
  var SOMA_OWNER_VERSION = '__VERSION__';
